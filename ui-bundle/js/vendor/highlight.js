!function () {
    ...
    function a(e) {
        var n = {begin: u = "[" + (u = "a-zA-Z_\\-!.?+*=<>&#'") + "][" + u + "0-9/;:]*", relevance: 0},
            a = {className: "number", begin: "[-+]?\\d+(\\.\\d+)?", relevance: 0},
            t = e.inherit(e.QUOTE_STRING_MODE, {illegal: null}), i = e.COMMENT(";", "$", {relevance: 0}),
            s = {className: "literal", begin: /\b(true|false|nil)\b/}, r = {begin: "[\\[\\{]", end: "[\\]\\}]"},
            l = {className: "comment", begin: "\\^" + u}, o = e.COMMENT("\\^\\{", "\\}"),
            c = {className: "symbol", begin: "[:]{1,2}" + u}, d = {begin: "\\(", end: "\\)"},
        ...
        return d.contains = [e.COMMENT("comment", ""), u, g], g.contains = n, r.contains = n, o.contains = [r], {
            aliases: ["clj"],
            illegal: /\S/,
    ...
    function t(e) {
        ...
        var a = "decltype\\(auto\\)", t = "[a-zA-Z_]\\w*::", i = {className: "keyword", begin: "\\b[a-z\\d_]*_t\\b"},
            s = {
            ...
            }, o = {className: "title", begin: n(t) + e.IDENT_RE, relevance: 0}, t = n(t) + e.IDENT_RE + "\\s*\\(", c = {
            ...
            }, d = [i, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, r, s], g = {
                ...
                keywords: c,
                illegal: /[^\w\s\*&:<>]/,
                contains: [{begin: a, keywords: c, relevance: 0}, {
                    begin: t,
                    returnBegin: !0,
                    contains: [o],
                    relevance: 0
    ...
    function gherkin(e) {
        return {
            ...
            contains: [
                {
                    className: 'keyword',
                    begin: '(\\* |А |Дано |Допустим |Если |Затем |И |Иначе |Когда |Но |Пусть |Также |То |Тогда )',
                    relevance: 0
                },
                {
                    className: 'meta',
    ...
    function _(e) {
        var n = "<>", a = "</>", t = /<[A-Za-z0-9\\._:-]+/, i = /\/[A-Za-z0-9\\._:-]+>|\/>/,
            s = "[A-Za-z$_][0-9A-Za-z$_]*", r = {
                ...
                relevance: 0
            }, o = {className: "subst", begin: "\\$\\{", end: "\\}", keywords: r, contains: []}, c = {
                begin: "html`",
                end: "",
            ...
            }, g = {className: "string", begin: "`", end: "`", contains: [e.BACKSLASH_ESCAPE, o]},
        ...
        return {
            ...
            contains: [{className: "meta", relevance: 10, begin: /^\s*['"]use (strict|asm)['"]/}, {
                ...
                contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, e.REGEXP_MODE, {
                    ...
                    variants: [{begin: n, end: a}, {
                        begin: t,
                        end: i
                    }], subLanguage: "xml", contains: [{begin: t, end: i, skip: !0, contains: ["self"]}]
                }],
                relevance: 0
            }, {
                className: "function",
                ...
                excludeEnd: !0,
                contains: [e.inherit(e.TITLE_MODE, {begin: s}), {
                    className: "params",
                    begin: /\(/,
                    end: /\)/,
                    excludeBegin: !0,
    ...
    function x(e) {
        ...
        return s.contains = r, {
            ...
            keywords: a,
            illegal: /\/\*/,
            contains: t.concat([{begin: /^\s*=>/, starts: {end: "$", contains: l.contains = r}}, {
                className: "meta",
    ...
    D = function (t) {
        var a, g = [], s = Object.keys, w = Object.create(null), r = Object.create(null), O = !0,
            n = /^(no-?highlight|plain|text)$/i, l = /\blang(?:uage)?-([\w-]+)\b/i, i = /((^(<[^>]+>|\t|)+|(?:\n)))/gm,
            M = "</span>", x = "Could not find the language '{}', did you forget to load/include a language module?",
        ...
        function k(n, e, t, a) {
            ...
            function s(e, n, a, t) {
                return a || "" !== n ? e ? (t = '<span class="' + (t ? "" : C.classPrefix), (t += e + '">') + n + (a ? "" : M)) : n : ""
            }

            function r() {
                var e, n, a, t, i;
                if (!m.keywords) return S(E);
                for (a = "", m.lexemesRe.lastIndex = e = 0, n = m.lexemesRe.exec(E); n;) a += S(E.substring(e, n.index)), t = m, i = n, i = _.case_insensitive ? i[0].toLowerCase() : i[0], (t = t.keywords.hasOwnProperty(i) && t.keywords[i]) ? (N += t[1], a += s(t[0], S(n[0]))) : a += S(n[0]), e = m.lexemesRe.lastIndex, n = m.lexemesRe.exec(E);
                return a + S(E.substr(e))
            }

            function l() {
                var e, n;
                p += null != m.subLanguage ? (n = "string" == typeof m.subLanguage) && !w[m.subLanguage] ? S(E) : (e = n ? k(m.subLanguage, E, !0, b[m.subLanguage]) : A(E, m.subLanguage.length ? m.subLanguage : void 0), 0 < m.relevance && (N += e.relevance), n && (b[m.subLanguage] = e.top), s(e.language, e.value, !1, !0)) : r(), E = ""
            }

            function o(e) {
                p += e.className ? s(e.className, "", !0) : "", m = Object.create(e, {parent: {value: m}})
            }

            function c(e) {
                var n = e[0], e = e.rule;
                return e && e.endSameAsBegin && (e.endRe = new RegExp(n.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"), "m")), e.skip ? E += n : (e.excludeBegin && (E += n), l(), e.returnBegin || e.excludeBegin || (E = n)), o(e), e.returnBegin ? 0 : n.length
            }

            function d(e) {
                var n = e[0], e = i.substr(e.index), a = function e(n, a) {
                ...
                if (a) {
                    e = m;
                    for (e.skip ? E += n : (e.returnEnd || e.excludeEnd || (E += n), l(), e.excludeEnd && (E = n)); m.className && (p += M), m.skip || m.subLanguage || (N += m.relevance), (m = m.parent) !== a.parent;) ;
            ...
            function u(e, n) {
                ...
                if ("illegal" === n.type && !t) throw new Error('Illegal lexeme "' + a + '" for mode "' + (m.className || "<unnamed>") + '"');
                if ("end" === n.type) {
                    e = d(n);
                    if (null != e) return e
                }
            ...
            var _ = R(n);
            if (!_) throw console.error(x.replace("{}", n)), new Error('Unknown language: "' + n + '"');
            T(_);
            for (var m = a || _, b = {}, p = "", f = m; f !== _; f = f.parent) f.className && (p = s(f.className, "", !0) + p);
            var E = "", N = 0;
            try {
                for (var h, v, y = 0; ;) {
                    if (m.terminators.lastIndex = y, !(h = m.terminators.exec(i))) break;
                    v = u(i.substring(y, h.index), h), y = h.index + v
                }
                for (u(i.substr(y)), f = m; f.parent; f = f.parent) f.className && (p += M);
                ...
                if (O) return {relevance: 0, value: S(i), language: n, top: m, errorRaised: e};
                throw e
            }
        }
        ...
        function N(e) {
            var n, a, t, i, s = function (e) {
                ...
                if (r += e.parentNode ? e.parentNode.className : "", a = l.exec(r)) return (s = R(a[1])) || (console.warn(x.replace("{}", a[1])), console.warn("Falling back to no-highlight mode for this block.", e)), s ? a[1] : "no-highlight";
                for (n = 0, t = (r = r.split(/\s+/)).length; n < t; n++) if (c(i = r[n]) || R(i)) return i
            }(e);
            c(s) || (C.useBR ? (a = document.createElement("div")).innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n") : a = e, i = a.textContent, n = s ? k(s, i, !0) : A(i), (a = _(a)).length && ((t = document.createElement("div")).innerHTML = n.value, n.value = m(a, _(t), i)), n.value = E(n.value), e.innerHTML = n.value, e.className = (a = e.className, t = s, i = n.language, t = t ? r[t] : i, i = [a.trim()], a.match(/\bhljs\b/) || i.push("hljs"), -1 === a.indexOf(t) && i.push(t), i.join(" ").trim()), e.result = {
                language: n.language,
                re: n.relevance
        ...
        return t.highlight = k, t.highlightAuto = A, t.fixMarkup = E, t.highlightBlock = N, t.configure = function (e) {
            C = d(C, e)
        }, t.initHighlighting = h, t.initHighlightingOnLoad = function () {
            ...
            p(w[n] = a), a.rawDefinition = e.bind(null, t), a.aliases && a.aliases.forEach(function (e) {
                r[e] = n
            })
        }, t.listLanguages = function () {
            return s(w)
        }, t.getLanguage = R, t.requireLanguage = function (e) {
            var n = R(e);
            if (n) return n;
            throw new Error("The '{}' language is required, but not loaded.".replace("{}", e))
        }, t.autoDetection = y, t.inherit = d, t.debugMode = function () {
            O = !1
    ...
    }, L = "object" == typeof window && window || "object" == typeof self && self, void 0 === I || I.nodeType ? L && (L.hljs = D({}), "function" == typeof define) && define.amd && define([], function () {
        return L.hljs
    }) : D(I);
    !function () {
        "use strict";
        I.registerLanguage("asciidoc", e), I.registerLanguage("bash", n), I.registerLanguage("clojure", a), I.registerLanguage("cpp", t), I.registerLanguage("cs", i), I.registerLanguage("css", s), I.registerLanguage("diff", r), I.registerLanguage("dockerfile", l), I.registerLanguage("elixir", o), I.registerLanguage("gherkin", gherkin), I.registerLanguage("go", c), I.registerLanguage("groovy", d), I.registerLanguage("haskell", g), I.registerLanguage("java", u), I.registerLanguage("javascript", _), I.registerLanguage("json", m), I.registerLanguage("kotlin", b), I.registerLanguage("lua", p), I.registerLanguage("markdown", f), I.registerLanguage("nix", E), I.registerLanguage("none", N), I.registerLanguage("objectivec", h), I.registerLanguage("perl", v), I.registerLanguage("php", y), I.registerLanguage("properties", w), I.registerLanguage("puppet", O), I.registerLanguage("python", M), I.registerLanguage("ruby", x), I.registerLanguage("rust", C), I.registerLanguage("scala", S), I.registerLanguage("shell", T), I.registerLanguage("sql", k), I.registerLanguage("swift", A), I.registerLanguage("xml", R), I.registerLanguage("yaml", B), [].slice.call(document.querySelectorAll("pre code.hljs[data-lang]")).forEach(function (e) {
            I.highlightBlock(e)
        })
    }()
}();